public class SimpleQueue
{
    ...
    {
        /// This will add to the back of the queue
        _queue.Add(value);
    }
    ...
    private int Dequeue()
    {
        ...
        /// This will remove and return from the front of the queue
        var value = _queue[0];
        _queue.RemoveAt(0);
        return value;
    }
}
/// I need to do more study on queues and their implementation